...
echo -e >&2 ""
echo -e >&2 "    Correlated logs are a separate process (needs systemd-journal-remote):"
echo -e >&2 "      ./scripts/logs.sh start"
echo -e >&2 ""
echo -e >&2 "    To remove:"
echo -e >&2 "      ./scripts/logs.sh stop"
echo -e >&2 "      sudo rm -rf ${PLUGIN_DIR}/infra-sim.plugin ${INSTALL_DIR}"
echo -e >&2 "      sudo systemctl restart netdata"
echo -e >&2 "      sudo rm -f /var/log/journal/remote/remote-*.journal"
